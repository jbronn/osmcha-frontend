            ...
            <span className="flex-parent flex-parent--row mt12">
              ...
              {props.activeTeam ? (
                <Link
                  ...
                  className="mx3 bg-transparent border--white btn btn--s border border--1-on-hover border--darken5 border--darken25-on-hover round bg-darken10 bg-darken5-on-hover color-gray transition input wmax120 ml6"
                >
                  Back to teams
                </Link>
              ) : (
